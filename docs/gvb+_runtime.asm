...
6B12: 00 01 07 INT $0701  ; wait for a key
6B15: C9 00    CMP #$00
6B17: D0 06    BNE $6B1F
6B19: 20 B8 6F JSR $6FB8
6B1C: 4C 00 6B JMP $6B00
6B1F: C9 1F    CMP #$1F  ; F4 key
6B21: F0 DD    BEQ $6B00
6B23: C9 14    CMP #$14  ; up key
6B25: F0 D9    BEQ $6B00
6B27: C9 15    CMP #$15  ; down key
6B29: F0 D5    BEQ $6B00
6B2B: C9 13    CMP #$13  ; page up key
6B2D: F0 D1    BEQ $6B00
6B2F: C9 0E    CMP #$0E  ; page down key
6B31: F0 CD    BEQ $6B00
6B33: C9 0F    CMP #$0F  ; ??
6B35: F0 C9    BEQ $6B00
6B37: C9 1E    CMP #$1E   ; F3 key
6B39: F0 C5    BEQ $6B00
6B3B: C9 19    CMP #$19  ; HELP key
6B3D: F0 38    BEQ $6B77
6B3F: C9 1A    CMP #$1A  ; SHIFT key
6B41: F0 50    BEQ $6B93
6B43: C9 30    CMP #$30  ; '0' key
6B45: F0 40    BEQ $6B87
6B47: C9 1D    CMP #$1D  ; F2 key
6B49: D0 03    BNE $6B4E
6B4B: 4C D2 6B JMP $6BD2
6B4E: C9 17    CMP #$17  ; left key
6B50: D0 03    BNE $6B55
6B52: 4C 8E 6C JMP $6C8E
6B55: C9 1C    CMP #$1C  ; F1 key
6B57: F0 66    BEQ $6BBF
6B59: C9 16    CMP #$16  ; right key
6B5B: D0 03    BNE $6B60
6B5D: 4C 2B 6C JMP $6C2B
6B60: C9 0D    CMP #$0D  ; enter key
6B62: D0 03    BNE $6B67
6B64: 4C 0B 6C JMP $6C0B
6B67: C9 1B    CMP #$1B  ; esc key
6B69: D0 03    BNE $6B6E
...
6E7F: 20 2C 6F JSR $6F2C  ; get input string delta
6E82: 18       CLC
...
; get INPUT string delta for current input char
6F2C: AD C4 B8 LDA $B8C4
6F2F: D0 0D    BNE $6F3E  ; branch if replace mode
...
; scroll INVERSE / FLASH bit flags
71BA: A2 00    LDX #$00
71BC: 18       CLC
71BD: 8A       TXA
71BE: 48       PHA
...
7629: 68       PLA
762A: 68       PLA
762B: C0 16    CPY #$16   ; Y is the offset of address table of statements
...
7A5D: 20 36 72 JSR $7236  ; clear prompt buffer
7A60: A9 00    LDA #$00
...
7A84: 20 E5 7D JSR $7DE5  ; assert not direct mode
7A87: A9 00    LDA #$00
...
7A9B: A5 5F    LDA $5F
7A9D: 48       PHA
7A9E: 20 D8 96 JSR $96D8  ; get variable name and data pointer
7AA1: 68       PLA
7AA2: 85 5F    STA $5F
7AA4: 68       PLA
7AA5: 85 5E    STA $5E
...
7AF4: C9 02    CMP #$02
7AF6: D0 03    BNE $7AFB
7AF8: 20 F2 AC JSR $ACF2  ; clear last row
7AFB: 2C 08 B8 BIT $B808
7AFE: 10 06    BPL $7B06  ; branch if number
7B00: A9 00    LDA #$00
7B02: 8D 47 04 STA $0447
7B05: 60       RTS

7B06: A9 01    LDA #$01
7B08: 8D 47 04 STA $0447  ; set input mode to digit mode
7B0B: 60       RTS
...
; DEF statement
7DFA: 20 29 7E JSR $7E29  ; get function name
7DFD: 20 E5 7D JSR $7DE5  ; assert not direct mode
7E00: 20 EF 9C JSR $9CEF  ; assert token '('
7E03: A9 80    LDA #$80
7E05: 8D 0B B8 STA $B80B
7E08: 20 D8 96 JSR $96D8  ; get variable name and data pointer
7E0B: 20 2F 7D JSR $7D2F  ; assert function paramater is number
7E0E: 20 EC 9C JSR $9CEC  ; assert token ')'
7E11: A9 D1    LDA #$D1
7E13: 20 F4 9C JSR $9CF4  ; assert token '='
7E16: 48       PHA
7E17: A5 59    LDA $59
7E19: 48       PHA
7E1A: A5 58    LDA $58
...
7E20: A5 5E    LDA $5E
7E22: 48       PHA
7E23: 20 60 76 JSR $7660  ; skip to next unquoted ':' or $00
7E26: 4C 98 7E JMP $7E98

7E29: A9 C2    LDA #$C2
7E2B: 20 F4 9C JSR $9CF4  ; assert token FN
7E2E: 09 80    ORA #$80
7E30: 8D 0B B8 STA $B80B
7E33: 20 DE 96 JSR $96DE  ; get variable name and data pointer
7E36: 85 6A    STA $6A
7E38: 84 6B    STY $6B
...
889A: A9 00    LDA #$00
889C: A0 0C    LDY #$0C
889E: 99 2B B9 STA $B92B,Y  ; clear INVERSE / FLASH bit flags
88A1: 88       DEY
88A2: 10 FA    BPL $889E
88A4: 60       RTS
...
8E74: 20 D8 96 JSR $96D8  ; get variable name and data pointer
8E77: 85 5C    STA $5C
8E79: 84 5D    STY $5D
8E7B: A6 5E    LDX $5E
8E7D: A4 5F    LDY $5F
...
8E85: 20 04 96 JSR $9604  ; check if offset >= file length
8E88: D0 03    BNE $8E8D
...
; WRITE statement
8F65: 48       PHA
8F66: 20 E5 7D JSR $7DE5  ; assert not direct mode
8F69: A9 00    LDA #$00
...
8FEF: 68       PLA
8FF0: 20 7A 9B JSR $9B7A  ; evaluate expression
8FF3: AD 08 B8 LDA $B808
8FF6: 8D 03 B8 STA $B803
8FF9: 30 06    BMI $9001  ; branch if string
8FFB: 20 8E A4 JSR $A48E  ; convert FAC1 to string
8FFE: 20 D0 7E JSR $7ED0
9001: AD 03 B8 LDA $B803
9004: 10 05    BPL $900B  ; branch if number
9006: A9 22    LDA #$22  ; '"'
...
9023: 10 05    BPL $902A  ; branch if write to screen
9025: A9 FF    LDA #$FF
9027: 20 1A 73 JSR $731A  ; if write to file, write an extra $FF
902A: A9 00    LDA #$00
902C: 20 1A 73 JSR $731A
902F: AD 0C B8 LDA $B80C
9032: 10 1B    BPL $904F  ; branch if write to screen
9034: 20 7F 90 JSR $907F  ; write to file
...
904F: 20 9C 6F JSR $6F9C  ; write to text buffer
9052: 4C 9A AD JMP $AD9A  ; update screen
...
9071: 10 06    BPL $9079  ; branch if write to screen
9073: 20 7F 90 JSR $907F  ; write to file
9076: 4C E9 8F JMP $8FE9

9079: 20 9C 6F JSR $6F9C  ; write to text buffer
...
90A0: A9 B9    LDA #$B9
90A2: 85 81    STA $81
90A4: 20 7B 96 JSR $967B  ; write file
...
; FIELD statement
90B2: 08       PHP
90B3: 20 E5 7D JSR $7DE5  ; assert not direct mode
90B6: 28       PLP
90B7: D0 03    BNE $90BC
90B9: 4C 8E 91 JMP $918E  ; syntax error
90BC: C9 23    CMP #$23  ; '#'
90BE: F0 08    BEQ $90C8
90C0: A5 5E    LDA $5E
90C2: D0 02    BNE $90C6
...
90CD: 20 C4 85 JSR $85C4  ; evaluate expression and assert result is 0~255
90D0: 8A       TXA
90D1: A2 01    LDX #$01
90D3: C9 04    CMP #$04
90D5: 90 03    BCC $90DA
...
90EF: C9 04    CMP #$04
90F1: F0 03    BEQ $90F6
90F3: 4C 8E 91 JMP $918E  ; syntax error if not RANDOM mode
90F6: 8A       TXA
90F7: 0A       ASL
90F8: AA       TAX
...
9112: A9 00    LDA #$00
9114: A0 00    LDY #$00
9116: 91 56    STA ($56),Y  ; clear record space for this file
9118: C8       INY
...
9128: 20 C4 85 JSR $85C4  ; evaluate expression and assert result is in 0~255
912B: 18       CLC
...
9157: 20 D8 96 JSR $96D8  ; get variable name and data pointer
915A: 2C 08 B8 BIT $B808
915D: 30 03    BMI $9162  ; branch if string
915F: 4C 8E 91 JMP $918E  ; syntax error
9162: 85 5C    STA $5C
9164: 84 5D    STY $5D
9166: A0 00    LDY #$00
9168: A5 73    LDA $73
...
; GET statement
9198: 08       PHP
9199: 20 E5 7D JSR $7DE5  ; assert not direct mode
919C: 28       PLP
919D: D0 03    BNE $91A2
...
91C7: C9 04    CMP #$04
91C9: F0 03    BEQ $91CE
91CB: 4C 8E 91 JMP $918E  ; syntax error if not RANDOM mode
91CE: 8A       TXA
91CF: 0A       ASL
91D0: AA       TAX
91D1: BD EC B8 LDA $B8EC,X
91D4: D0 03    BNE $91D9
91D6: 4C 8E 91 JMP $918E  ; syntax error if file not open
...
91F9: 20 F2 9C JSR $9CF2  ; assert token ','
91FC: 20 7A 9B JSR $9B7A  ; evaluate expression
...
9226: 05 73    ORA $73
9228: D0 03    BNE $922D
922A: 4C 0C 94 JMP $940C  ; record number error
922D: A5 72    LDA $72
922F: A6 73    LDX $73
9231: 86 72    STX $72
9233: 85 73    STA $73
...
9248: 85 82    STA $82
924A: 20 3F A9 JSR $A93F  ; get offset from LEN and record number
924D: A5 85    LDA $85
924F: F0 03    BEQ $9254
9251: 4C 0C 94 JMP $940C  ; report record number error if file offset > 65535
9254: 18       CLC
9255: A5 83    LDA $83
...
926E: 90 05    BCC $9275
9270: F0 03    BEQ $9275
9272: 4C 0C 94 JMP $940C  ; report record number error if file length not enough for reading a record
9275: A5 83    LDA $83
9277: 8D 24 B9 STA $B924
927A: A5 84    LDA $84
927C: 8D 25 B9 STA $B925
927F: 20 DE 95 JSR $95DE  ; fseek
9282: A5 5E    LDA $5E
...
9294: F0 13    BEQ $92A9
9296: 20 1A 96 JSR $961A  ; read a byte from file
...
; PUT statement
92C1: 08       PHP
92C2: 20 E5 7D JSR $7DE5  ; assert not direct mode
92C5: 28       PLP
92C6: D0 03    BNE $92CB
...
92D3: C6 5F    DEC $5F
92D5: C6 5E    DEC $5E
92D7: 20 C4 85 JSR $85C4  ; evaluate expression and assert result in 0~255
92DA: E0 04    CPX #$04
92DC: 90 03    BCC $92E1
...
9322: 20 F2 9C JSR $9CF2  ; assert token ','
9325: 20 7A 9B JSR $9B7A  ; evaluate expression
...
936E: 85 82    STA $82
9370: 20 3F A9 JSR $A93F  ;  get file offset
9373: A5 85    LDA $85
9375: F0 03    BEQ $937A
...
93D9: A9 B9    LDA #$B9
93DB: 85 81    STA $81
93DD: 20 7B 96 JSR $967B  ; write file
...
93F3: 90 0C    BCC $9401
93F5: AD 24 B9 LDA $B924  ; if append new record, update file length in open file descriptor
...
95B6: C9 01    CMP #$01
95B8: F0 03    BEQ $95BD
95BA: 4C D9 95 JMP $95D9  ; report error if not INPUT mode
95BD: 8A       TXA
95BE: 0A       ASL
95BF: AA       TAX
95C0: A0 00    LDY #$00
...
95D9: A2 22    LDX #$22  ; file mode error
...
9662: 00 16 05 INT $0516  ; read file
9665: A2 16    LDX #$16  ; file read error
9667: 90 03    BCC $966C
...
969C: C9 FE    CMP #$FE
969E: 90 05    BCC $96A5
96A0: A2 26    LDX #$26  ; file too long
...
96BB: 00 18 05 INT $0518  ; write file
96BE: B0 01    BCS $96C1
96C0: 60       RTS
...
A3C9: 90 17    BCC $A3E2
A3CB: C9 CA    CMP #$CA  ; '-' token
A3CD: F0 0E    BEQ $A3DD
A3CF: C9 2D    CMP #$2D  ; '-'
A3D1: F0 0A    BEQ $A3DD
A3D3: C9 C9    CMP #$C9  ; '+' token
A3D5: F0 08    BEQ $A3DF
A3D7: C9 2B    CMP #$2B  ; '+'
A3D9: F0 04    BEQ $A3DF
A3DB: D0 07    BNE $A3E4
...
A3FD: F0 12    BEQ $A411
A3FF: 10 09    BPL $A40A
A401: 20 B1 A0 JSR $A0B1  ; / 10
A404: E6 67    INC $67
A406: D0 F9    BNE $A401
A408: F0 07    BEQ $A411

A40A: 20 95 A0 JSR $A095  ; * 10
A40D: C6 67    DEC $67
A40F: D0 F9    BNE $A40A

A411: A5 75    LDA $75
A413: 30 01    BMI $A416  ; minus operator
A415: 60       RTS
...
A42D: 48       PHA
A42E: 20 D3 A1 JSR $A1D3  ; round FAC1 then move into FAC2
A431: 68       PLA
A432: 20 05 A2 JSR $A205  ; move signed number from A into FAC1
A435: A5 7C    LDA $7C
A437: 45 74    EOR $74
A439: 85 7D    STA $7D
A43B: A6 6F    LDX $6F
A43D: 4C B0 9D JMP $9DB0  ; + operator
...
A4A2: A6 6F    LDX $6F
A4A4: D0 03    BNE $A4A9
A4A6: 4C B1 A5 JMP $A5B1  ; branch if 0
...
A4B1: A9 6C    LDA #$6C
A4B3: A0 A4    LDY #$A4
A4B5: 20 C9 9F JSR $9FC9  ; FAC1 * 1,000,000,000
A4B8: A9 F7    LDA #$F7  ; exponent -9
A4BA: 85 66    STA $66  ; base-10 exponent
A4BC: A9 67    LDA #$67
A4BE: A0 A4    LDY #$A4
...
ADA8: D0 1F    BNE $ADC9  ; branch if GRAPH mode
ADAA: A9 00    LDA #$00
